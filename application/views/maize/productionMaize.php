...
<form name="productionMaize" id="productionMaize" method="post"
    ...
    <div class="row-fluid" >
        <div class="span5" >
         <div class="span12"><br />
          ...
          <label>Maize Factory<select name="maizeFactory" id="maizeFactory" <?php if($sel_compid>1){?>disabled="disabled"	<?php }?> style="width: 98% !important;">
 ...
 <div class="span12"><br />
            ...
            <h2 class="blue" style="width:98%; background: transparent; border: none;">Premix Details</h2> <div class="span12"><br />
			
            <label>Opening Balance (kg)<input type="number" id="oBal_1" style="width: 98% !important; height: 25px;" name="oBal_1" class="cloned" value="<?php if(isset($details)){ echo $details[0]->opening_balance;}?>"/></label>
            </div>
             <div class="span12"><br />
          ...
          <label>Closing Balance 
            (kg)
            <input type="number" id="CBAL_1" style="width: 98% !important; height: 25px;"  name="CBAL_1" class="cloned" value="<?php if(isset($details)){ echo $details[0]->closing_balance;}?>"/></label></div>
      </div>
    ...
    <div class="span12"><br />
            ...
            <label>Dosage Rate (g/mt)<input type="number" id="DRM_1" style="width: 98% !important; height: 25px;" name="DRM_1" class="cloned" value="<?php if(isset($details)){ echo $details[0]->dosage_rate;}?>"/></label>
            </div>
            <div class="span12"><br />

            <label>Theoretical Production Fortified (mt)<input type="number" id="tProdM_1" style="width: 98% !important; height: 25px;" name="tProdM_1" class="cloned" value="<?php if(isset($details)){ echo $details[0]->theoretical_prod;}?>"/></label>
            </div>
            <div class="span12"><br />

            <label>Actual Production Fortified (mt)<input type="number" id="aProd_1" style="width: 98% !important; height: 25px;" name="aProd_1" class="cloned" value="<?php if(isset($details)){ echo $details[0]->actual_prod;}?>"/></label>
            </div>
            <div class="span12"><br />
