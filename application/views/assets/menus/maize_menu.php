...
<li id="ulink" class="<?php echo ($active_link==="addproductionmaize")?"active":"";?>">
                <a href="<?php echo base_url()?>addproductionmaize">
                    <i class="icon-edit"></i>
                    <span class="menu-text"> <?php echo menuname("Maize",$this->userVehicle,"Production");?> Form </span>
               </a>
</li>
<!-- 
<li>
