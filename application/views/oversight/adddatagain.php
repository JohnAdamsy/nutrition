...
<form name="adddatagain" id="adddatagain" method="post"
      action="<?php echo base_url() ?>submit/c_form_oversite/adddatagain/0" class="form-horizontal">
  <input name="item_id" type="hidden" value="<?php echo (isset($item_id))? $item_id:"";?>" />
    ...
    <div>
      ...
      <?php if(!isset($item_id)){?>
        ...
        <button type="submit" class="btn btn-warning" formaction="<?php echo base_url() ?>submit/c_form_oversite/adddatagain/1">Save and Continue</button>
         <?php }
		else
		{?>        
