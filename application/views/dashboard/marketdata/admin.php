...
<script type="text/javascript">
    $(document).ready(function() {
		user=$('#dataCompany1').val();
	    oTable = $('#big_table').dataTable( {
		"bProcessing": true,
		"bServerSide": true,				
		"sAjaxSource": '<?php echo base_url(); ?>c_oversight/getmarketAdminData/'+user,
        "bJQueryUI": true,
	...
	$("#dataCompany").change(function() { fnFilterGlobal_market("getmarketAdminData");} );
	...
	$("#flogo").change(function() { fnFilterColumn("flogo",9);} );
...
<div class="span3">
<label>Data Company:
<input name="dataCompany1" id="dataCompany1" type="hidden" value="<?php echo $sel_compid?>" />
            <select name="dataCompany" id="dataCompany" <?php if($sel_compid>1){?>disabled="disabled"	<?php }?>>
